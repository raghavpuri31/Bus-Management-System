...
INSERT INTO `brs`.`route` (origin,destination) VALUES ('Delhi','Hyderabad');

INSERT INTO `brs`.`route` (origin,destination) VALUES ('Hyderabad','Delhi');

INSERT INTO `brs`.`route` (origin,destination) VALUES ('Mumbai','Bangalore');

INSERT INTO `brs`.`route` (origin,destination) VALUES ('Bangalore','Mumbai');

INSERT INTO `brs`.`route` (origin,destination) VALUES ('Visakhapatnam','Amritsar');

INSERT INTO `brs`.`route` (origin,destination) VALUES ('Amritsar','Visakhapatnam');

INSERT INTO `brs`.`route` (origin,destination) VALUES ('Bhopal','Bangalore');

INSERT INTO `brs`.`route` (origin,destination) VALUES ('Bangalore','Bhopal');
